        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="col-span-6 flex justify-center">
            <div className="flex flex-col align-middle justify-center p-10">
              ...
              <h4 className="text-lg pt-4 font-normal lh-33 text-center lg:text-start text-redgray">
              ...
              <Link
                href={"/"}
                className="mt-4 text-xl font-medium text-red flex gap-2 mx-auto lg:mx-0 space-links"
              >
                Learn more{" "}
                <Image
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-16 gap-y-10 lg:gap-x-40 px-10 py-12 bg-redbg rounded-3xl">
              {Aboutdata.map((item, i) => (
                ...
                >
                  ...
                  <h4 className="text-lg font-normal text-redgray my-2">
                    {item.paragraph}
                  </h4>
                </div>
              ))}
